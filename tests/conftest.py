"""
Shared pytest fixtures and configuration for Yume tests.
"""
...
# This allows: from yume.dream_worker import DreamWorker
...
async def mock_redis_client():
    ...
    # Enhanced mock with actual storage
...
def mock_clip_scorer(mock_clip_model_hf, mock_clip_processor):
    ...
    def score_fn(image, text):
        # Simple deterministic scoring based on image and text
